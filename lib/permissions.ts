...
export const getReportReturnPath = (role: UserRole | string | null | undefined): string => {
    const map: Record<string, string> = {
        ...
        DIVISI_OP: '/dashboard/operasional',
        PARTNER_OP: '/dashboard/operasional',
        DIVISI_OT: '/dashboard/operasional',
        PARTNER_OT: '/dashboard/operasional',
        DIVISI_UQ: '/dashboard/operasional',
        PARTNER_UQ: '/dashboard/operasional',
